...
package com.hifong.war.commands.rank
{
	...
	public final class ShowPlayerRankListByPlayerNameCommand extends SequenceCommand implements ICommand, IResponder
	{

		public override function execute(event:CairngormEvent) : void
		{
			var evt:ShowPlayerRankListByPlayerNameEvent = event as ShowPlayerRankListByPlayerNameEvent;
			var delegate:RankDelegate = new RankDelegate(this);
			delegate.getPlayerRankByPlayerName(evt.playerName);
		}
