...
package com.hifong.war.commands.rank
{
	...
	public final class ShowCityPopulationRankListByCityRankCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent) : void
		{
			var evt:ShowCityPopulationRankListByCityRankEvent = event as ShowCityPopulationRankListByCityRankEvent;
			var delegate:RankDelegate = new RankDelegate(this);
			delegate.getCityPopulationRankListByRank(evt.rank);
		}
		...
		public function result(data:Object) : void
		{
			...
			ModelLocator.getInstance().cityPopulationRankList = new ArrayCollection(array);
		}
