...
package com.hifong.war.commands.rank
{
	...
	public final class ShowGuildRankListByGuildRankCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent) : void
		{
			var evt:ShowGuildRankListByGuildRankEvent = event as ShowGuildRankListByGuildRankEvent;
			var delegate:RankDelegate = new RankDelegate(this);
			delegate.getGuildRankListByRank(evt.rank);
		}
		...
		public function result(data:Object) : void
		{
			...
			ModelLocator.getInstance().guildRankList = new ArrayCollection(array);
		}
