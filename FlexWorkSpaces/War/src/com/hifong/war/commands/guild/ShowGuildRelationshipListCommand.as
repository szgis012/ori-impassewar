...
package com.hifong.war.commands.guild
{
	...
	public final class ShowGuildRelationshipListCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent) : void
		{
			var evt:ShowGuildRelationshipListEvent = event as ShowGuildRelationshipListEvent;
			var delegate:GuildDelegate = new GuildDelegate(this);
			delegate.getGuildRelationshipListByGuildID(evt.guildID);
		}
		...
		public function result(data:Object) : void
		{
			...
			ModelLocator.getInstance().guildRelationshipList = new ArrayCollection(array);
		}
