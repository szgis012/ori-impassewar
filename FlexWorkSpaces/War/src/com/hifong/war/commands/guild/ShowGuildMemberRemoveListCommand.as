...
package com.hifong.war.commands.guild
{
	...
	public final class ShowGuildMemberRemoveListCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent) : void
		{
			var evt:ShowGuildMemberRemoveListEvent = event as ShowGuildMemberRemoveListEvent;
			var delegate:GuildDelegate = new GuildDelegate(this);
			delegate.getGuildMemberListByGuildID(evt.guildID);
		}
		...
		public function result(data:Object) : void
		{
			...
			ModelLocator.getInstance().guildMemberRemoveList = new ArrayCollection(array);
		}
