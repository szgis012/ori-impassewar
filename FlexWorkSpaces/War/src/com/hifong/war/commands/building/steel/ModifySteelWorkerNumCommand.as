...
package com.hifong.war.commands.building.steel
{
     ...
     *
     */
	public final class ModifySteelWorkerNumCommand implements ICommand, IResponder
	{
		...
		{
			var evt:ModifySteelWorkerNumEvent = event as ModifySteelWorkerNumEvent;
			this.workerNum = evt.workerNum;
			var delegate:ResourcesTuneDelegate = new ResourcesTuneDelegate( this );
			delegate.modifySteelWorkerNum(ModelLocator.getInstance().cityInfo.cityID,evt.workerNum);
		}
		
		public function result(data:Object) : void
		{
			//更新食物工人人数
			model.cityInfo.cityResource.steelWorkerNum = workerNum;
