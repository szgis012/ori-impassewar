...
package com.hifong.war.commands.building.citycenter
{
	...
	import com.hifong.war.events.building.citycenter.SafetyPatrolEvent;
     ...
     *
     */
	public final class SafetyPatrolCommand implements ICommand, IResponder
	{
		...
		{
			var evt:SafetyPatrolEvent = event as SafetyPatrolEvent;
			var delegate:CityCenterDelegate = new CityCenterDelegate( this );
			delegate.doSafetyPatrol(model.cityInfo.cityID);
		}
