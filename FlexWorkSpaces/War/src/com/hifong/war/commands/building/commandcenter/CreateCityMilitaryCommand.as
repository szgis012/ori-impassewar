...
package com.hifong.war.commands.building.commandcenter
{
	...
	import com.hifong.war.events.building.commandcenter.CreateCityMilitaryEvent;
	...
	public final class CreateCityMilitaryCommand implements ICommand, IResponder
	{
		...
		{
			var evt:CreateCityMilitaryEvent = event as CreateCityMilitaryEvent;
			this.cityID = evt.cityID;
			
			var delegate:CommandCenterDelegate = new CommandCenterDelegate(this);
			delegate.createCityMilitary(evt.cityID,evt.name,evt.cityHeroID);
		}
