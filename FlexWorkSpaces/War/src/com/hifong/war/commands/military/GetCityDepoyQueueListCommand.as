...
package com.hifong.war.commands.military
{
	...
	public final class GetCityDepoyQueueListCommand implements ICommand, IResponder
	{

		public function execute(event:CairngormEvent) : void
		{
			var evt:GetCityDepoyQueueListEvent = event as GetCityDepoyQueueListEvent;
			var delegate:DepoyQueueDelegate = new DepoyQueueDelegate(this);
			delegate.getCityDepoyQueueList(evt.cityID);
		}
