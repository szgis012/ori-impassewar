...
package com.hifong.war.commands.common
{
     ...
     *
     */
	public final class GetCityWithCityResourceByIDCommand implements ICommand, IResponder
	{
		...
		{
			var evt:GetCityWithCityResourceByIDEvent= event as GetCityWithCityResourceByIDEvent;
			var delegate:CityDelegate = new CityDelegate( this );
			delegate.getCityWithCityResourceByID(evt.cityID);
		}
