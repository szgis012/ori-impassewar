...
package com.hifong.war.commands.treasure
{
     ...
     *
     */
	public final class GetTreasureListByCategoryCommand implements ICommand, IResponder
	{
		...
		{
			var evt:GetTreasureListByCategoryEvent = event as GetTreasureListByCategoryEvent;
			var delegate:TreasureDelegate = new TreasureDelegate( this );
			delegate.getTreasureListByCategory(evt.category);
		}
